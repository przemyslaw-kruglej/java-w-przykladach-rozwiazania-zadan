...
public class PowiekszanieTablicy {
  public static void main(String[] args) {
    ...
    int[] powiekszonaDomyslnaWartosc = powiekszDwukrotnie(liczby, 5);

    System.out.println(Arrays.toString(powiekszona));
    System.out.println(Arrays.toString(powiekszonaDomyslnaWartosc));
  }
  ...
  public static int[] powiekszDwukrotnie(int[] tab, int domyslnaWartosc) {
